...
- do true 4hz by skipping, see if thats the same, will be very interesting and inform if we can lower frame rate

## notes from raghav

- sart with diagram open, quick overview, we learned about light sheet today / isoview in the lecture, as raghav alluded to, isoview consists of multiple perspecives or "views", sample goes in this chamber that is in the center. 4 copies on 4 quadrants, each quadrant has a light path, most important for the data perspective is 4 perspectives of the same sample

- touch on the activity of the calcium indicator
- before showing multifused: " now i have data along view 00 and 90", now i need to register and fuse them. For that, there is an open source tool available in fiji, its called bigstitcher, 

- Dont make it a tutorial, frame as a solution not problem
