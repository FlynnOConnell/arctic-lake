...
## adaptive blending fix

Only view1 has signal → use view1 directly (no averaging with zeros)
Only view2 has signal → use view2 directly
Neither has signal → leave zero
Both have signal → proceed with normal blending logic (unchanged)
LBM-CaImAn-MATLAB Results:

![](../static/images/2026-02-19-08-39-06.png)
