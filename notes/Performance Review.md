...
* Develop GUI for MBO pipelines
* Integrate new tools and maintain global collaboration network
* Attend conferences to promote MBO

---

### Suite3D Contributions

* [PR: CLI and install improvements](https://github.com/alihaydaroglu/suite3d/pull/95)
* [Issue: parameter exploration on MBO data](https://github.com/alihaydaroglu/suite3d/issues/83)
