---
citekey: rastermap_2024
title: "Stringer & Pachitariu 2024 — Rastermap: a discovery method for neural population recordings"
category: literature
cluster: calcium-imaging
tags: [rastermap, clustering, visualization, dimensionality-reduction]
tools: [rastermap]
related: [suite2p_2017]
pdf:
...
A clustering algorithm. Goal: Sort neurons that have similar functional properties and activity patterns.

PDF: _not in repo_ · full text: [source.md](source.md) · Figures: [`figures/`](figures/) · [nature.com](https://www.nature.com/articles/s41593-024-01783-4)

Usage/implementation notes: [Rastermap (software)](../../software/rastermap.md)
