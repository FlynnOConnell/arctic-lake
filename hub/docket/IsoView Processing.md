...
> [!important] Processing Mode
>IsoView is a 4-camera paradigm, however  this pipeline supports multiple camera/channel paradigms via`processingMode`
>
> We start with  2-view camera fusion (mode 2)
...
| 2       | 1        | 2    | **2-view camera fusion**  | `_CM00_CM01_CHN00`            |
## General notes
- Opening .klb in ImageJ is inconvenient
	- need to import -> klb
	- no drag+drop
	- often freezes loading projections
- Took around an hour for all timepoints
- `processingMode` defines 
...
> [!info]
> 
>This aim will likely take the longest to step through each of the main functions to grasp the general steps performed in each pipeline.
> 

### Environment
- **MATLAB Version:** 2024a (also available: 2022b, 2023b)
- **Cluster node:** RBO-W2
- **Input format:** `.klb`
- **Tools:** MATLAB, Fiji/ImageJ, BigDataViewer, BigStitcher

Each IsoView channel (viewing axis) is treated as a separate SiMView dataset.
...
4. [[hub/literature/lemon_keller_2015/notes|notes]]
